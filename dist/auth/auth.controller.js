...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Verify email with OTP (no token issued)' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Login and receive an access token + refresh token' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Logout and revoke the refresh token' }),
